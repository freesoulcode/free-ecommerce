...
.PHONY: help proto proto-user proto-auth proto-product proto-cart proto-order test test-user-service test-auth-service test-product-service test-cart-service test-order-service test-buyer-api mysql-up mysql-status mysql-down run-user-service run-buyer-api run-auth-service run-product-service run-cart-service run-order-service
...
help:
	...
	@printf "%-24s %s\n" "test" "Run auth-service, buyer-api, user-service, product-service, cart-service, order-service and generated code tests"
...
proto: proto-user proto-auth proto-product proto-cart proto-order
...
test:
	@go test ./backend/services/user-service/... ./backend/services/auth-service/... ./backend/services/product-service/... ./backend/services/cart-service/... ./backend/services/order-service/... ./backend/apis/buyer-api/... ./gen/go/proto/...
...
run-buyer-api:
	@BUYER_API_HTTP_ADDR=127.0.0.1:18080 BUYER_API_USER_SERVICE_GRPC_ADDR=127.0.0.1:19082 BUYER_API_AUTH_SERVICE_GRPC_ADDR=127.0.0.1:19081 BUYER_API_PRODUCT_SERVICE_GRPC_ADDR=127.0.0.1:19083 BUYER_API_CART_SERVICE_GRPC_ADDR=127.0.0.1:19084 BUYER_API_ORDER_SERVICE_GRPC_ADDR=127.0.0.1:19085 go run ./backend/apis/buyer-api/cmd/buyer-api
