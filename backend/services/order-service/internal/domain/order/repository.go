...
type Repository interface {
	...
	MarkMerchantShopOrderShipped(ctx context.Context, shopID, shopOrderID int64, updatedAt time.Time) (*MerchantShopOrderDetail, error)
	MarkBuyerShopOrderReceived(ctx context.Context, userID, shopOrderID int64, updatedAt time.Time) (*Group, error)
